...
exports.init = function(app)  {
	...
	app.get('/api/admin', serviceFactory.getAdminService().getAdmins);
	app.post('/api/admin', serviceFactory.getAdminService().createAdmin);
	app.delete('/api/admin/:adminId', serviceFactory.getAdminService().deleteAdminById);

...
exports.updateNewsById = function(req, res, next) {

	var News = req.app.db.data.model('news');

	News.safeFindById(req.params.newsId,
		function success(result) {
...
exports.updateCoverById = function(req, res, next) {

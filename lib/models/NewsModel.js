...
exports.init = function(app) {
	...
	*/
	...
	/*
	* Find by id and return raw data
	*/
	NewsSchema.statics.safeFindById = function(_id, callback, errback) {
		this.findOne({_id: _id},
			function success(err, news) {
				if (err) {
					errback(err);
	...
	* Update cover image
	*/
	NewsSchema.methods.updateCover = function(news, callback, errback) {
